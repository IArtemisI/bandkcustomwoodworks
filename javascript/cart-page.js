	...
	const render = () => {
		...
		items.forEach((line) => {
         ...
         <div class="cart-item-info">
            ...
            <div class="cart-qty">
               <button class="cart-qty-btn" type="button" data-action="dec" data-id="${
									line.id
								}">−</button>
               <span class="cart-qty-num">${qty}</span>
               <button class="cart-qty-btn" type="button" data-action="inc" data-id="${
									line.id
								}">+</button>
               <button class="cart-remove" type="button" data-action="remove" data-id="${
									line.id
